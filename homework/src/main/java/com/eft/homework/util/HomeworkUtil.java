...
public final class HomeworkUtil {
	...
	public static ClearSettleResult sendHttpRequest(HomeworkEnums.ClearSettle clearSettle, Map<String, Object> params){
		ClearSettleResult result = new ClearSettleResult();
